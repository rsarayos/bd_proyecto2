...
public class Costos {
    ...
    /**
     * Método que obtiene el costo de una licencia en base al tipo de licencia y si la persona es discapacitada o no.
     *
    ...
    /**
     * Método que obtiene el costo de tramitación de placas para un automóvil, dependiendo de si es nuevo o usado.
     *
