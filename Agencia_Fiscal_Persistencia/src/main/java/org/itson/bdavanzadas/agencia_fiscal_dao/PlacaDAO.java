...
public class PlacaDAO implements IPlacaDAO {
    ...
    static final Logger logger = Logger.getLogger(PlacaDAO.class.getName());
    ...
    try {
        ...
        String jpqlUpdate = "UPDATE Placa p SET p.estado = :estado WHERE p.numeroPlaca = :numPlaca";
        ...
        if (updatedCount > 0) {
            ...
            entityManager.getTransaction().commit();
            logger.log(Level.INFO, "Se modificó el estado de la Placa");
